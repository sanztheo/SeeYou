    ...
    <div className="w-72 backdrop-blur-sm border rounded-lg shadow-xl bg-gray-800/95 border-gray-700/50">
      ...
      <div className="p-3 space-y-2 text-xs">
        <div className="flex justify-between gap-2">
          <span className="text-gray-400 shrink-0">Magnitude</span>
          <span
        ...
        <div className="flex justify-between gap-2">
          <span className="text-gray-400 shrink-0">Depth</span>
        ...
        {earthquake.tsunami && (
          <div className="flex justify-between gap-2">
            <span className="text-gray-400 shrink-0">Tsunami</span>
        ...
        {earthquake.felt != null && earthquake.felt > 0 && (
          <div className="flex justify-between gap-2">
            <span className="text-gray-400 shrink-0">Felt reports</span>
            <span className="text-gray-100 font-mono">{earthquake.felt}</span>
          </div>
        )}
