...
fn worldwide_cameras() -> Vec<Camera> {
    let cams: Vec<(&str, &str, &str, &str, f64, f64, &str, StreamType)> = vec![
        ...
        (
            ...
            37.4979,
            127.0276,
            "http://210.179.218.52:1935/live/131.stream/playlist.m3u8",
            StreamType::Hls,
        ),
        (
            "seoul-hongdae",
            ...
            37.5563,
            126.9236,
            "http://210.179.218.52:1935/live/148.stream/playlist.m3u8",
            StreamType::Hls,
        ),
        // Amsterdam
        (
            ...
            52.3388,
            4.8925,
            "https://webcam.a10ringsouth.nl/cam1.jpg",
            StreamType::ImageRefresh,
        ),
        (
            "ams-dam-square",
            ...
            52.3731,
            4.8932,
            "https://www.youtube.com/embed/ggvLyn7YPeA",
            StreamType::Hls,
        ),
        // Berlin
        (
            ...
            52.5163,
            13.3777,
            "https://www.youtube.com/embed/YRvfYCAwnWg",
            StreamType::Hls,
        ),
        (
            "berlin-alex",
            ...
            52.5219,
            13.4132,
            "https://www.youtube.com/embed/xOBeVXNtiNE",
            StreamType::Hls,
        ),
        // Rome
        (
            ...
            41.8902,
            12.4922,
            "https://www.youtube.com/embed/TkWLNLmSvYM",
            StreamType::Hls,
        ),
        (
            "rome-trevi",
            ...
            41.9009,
            12.4833,
            "https://www.youtube.com/embed/K3M6JCpdTcA",
            StreamType::Hls,
        ),
        // Bangkok
        (
            ...
            13.7456,
            100.5332,
            "https://www.youtube.com/embed/4cHREwjmPi8",
            StreamType::Hls,
        ),
        (
            "bkk-sukhumvit",
            ...
            13.7372,
            100.5601,
            "https://www.youtube.com/embed/xV11b6tTd0o",
            StreamType::Hls,
        ),
        // Singapore
        (
            ...
            1.2839,
            103.8607,
            "https://www.youtube.com/embed/Oc6shXvnMOc",
            StreamType::Hls,
        ),
        // Dubai
        (
            ...
            25.1972,
            55.2744,
            "https://www.youtube.com/embed/83x5-pNQmSo",
            StreamType::Hls,
        ),
        // Hong Kong
        (
            ...
            22.2930,
            114.1694,
            "https://www.youtube.com/embed/WxB1gB6K-2A",
            StreamType::Hls,
        ),
        // Toronto
        (
            ...
            43.6426,
            -79.3871,
            "https://www.youtube.com/embed/kMW0QLrBrjo",
            StreamType::Hls,
        ),
        (
            "tor-dundas",
            ...
            43.6561,
            -79.3802,
            "https://www.youtube.com/embed/YDYNnguU8WU",
            StreamType::Hls,
        ),
        // Rio
        (
            ...
            -22.9714,
            -43.1822,
            "https://www.youtube.com/embed/0KY1HEFC8Hs",
            StreamType::Hls,
        ),
        // Moscow
        (
            ...
            55.7539,
            37.6208,
            "https://www.youtube.com/embed/IZEBMDup2TQ",
            StreamType::Hls,
        ),
        // Istanbul
        (
            ...
            41.0086,
            28.9802,
            "https://www.youtube.com/embed/V7a0HwMEkJM",
            StreamType::Hls,
        ),
        // Barcelona
        (
            ...
            41.4036,
            2.1744,
            "https://www.youtube.com/embed/WZZoCDAX5u0",
            StreamType::Hls,
        ),
        // Prague
        (
            ...
            50.0870,
            14.4210,
            "https://www.youtube.com/embed/3WdoOm0rBZo",
            StreamType::Hls,
        ),
        // Buenos Aires
        (
            ...
            -34.6037,
            -58.3816,
            "https://www.youtube.com/embed/GbLxYhFDiyA",
            StreamType::Hls,
        ),
        // Nairobi
        (
            ...
            -1.2864,
            36.8172,
            "https://www.youtube.com/embed/HL4FZhkFDCE",
            StreamType::Hls,
        ),
        // Cape Town
        (
            ...
            -33.9628,
            18.4098,
            "https://www.youtube.com/embed/XHm3FQXvyRQ",
            StreamType::Hls,
        ),
        // Mumbai
        (
            ...
            18.9432,
            72.8235,
            "https://www.youtube.com/embed/kMbPYHF0cj0",
            StreamType::Hls,
        ),
    ];
